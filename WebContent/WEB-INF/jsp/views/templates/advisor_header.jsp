<%@include file="top_header.jsp" %>
			<div>
				...
				<li><a href="defaulters"><font style="color:#e67e22">Defaulter List</font></a></li>
				<li><a href=" "><font style="color:#e67e22">Avalaibility:<input type="checkbox" name="avail"/></font></a></li>
