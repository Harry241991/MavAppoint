...
<div class="container">
    ...
    <input type=hidden name=groupMailIds id="groupMailIds">
		    		...
		    		<% ArrayList<Appointment> array = (ArrayList<Appointment>)session.getAttribute("appointments");
		    			if (array != null){%>
							...
							<tr>
								...
								<td class="text-center"><input type="checkbox" id=box_<%=i%> onclick="button_<%=i%>()"></td>
							</tr>
								...
								<script>
										function button_<%=i%>(){
											var email = document.getElementById("groupMailIds").value;
											if(email==null || email==" " || email.length<=0){
												document.getElementById("groupMailIds").value = "<%=array.get(i).getStudentEmail()%>";}
											else{
												
												document.getElementById("groupMailIds").value = email+ " ;<%=array.get(i).getStudentEmail()%>";
						...
						<tr>
								<td colspan="11">   </td>
								<td class="text-center"><button type="button" onclick="sendGroupMail()">GEmail</button></td>
							</tr>
							<script> function emailSend(){
								...
								function sendGroupMail(){
									//alert(document.getElementById("groupMailIds").value);
									var to = document.getElementById("groupMailIds").value;
									var body = "You have appointment today";
